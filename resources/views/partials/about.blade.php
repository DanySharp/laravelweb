...
@foreach($abouts as $linkha)


<div class="w3-row-padding w3-center w3-margin-top">
    <div class="w3-third">
        <div class="w3-card w3-container" style="min-height:460px">
            <h3>{{$linkha->title}}</h3><br>
            <i class="fa fa-at w3-margin-bottom w3-text-theme" style="font-size:120px"></i>
            <a style="text-decoration: none;color: #FFFFFF" href=""><p style="color: #2a45ff;font-family: 'Segoe UI'">{{$linkha->phone}}</p></a><br>
            <a style="text-decoration: none;color: #FFFFFF" href=""><p style="color: #2a45ff;font-family: 'Segoe UI'">{{$linkha->email}}</p></a><br>
            <a style="text-decoration: none;color: #FFFFFF" href="{{$linkha->link}}"><p style="color: #2a45ff;font-family: 'Segoe UI'">{{$linkha->link}}</p></a>
    ...
    <div class="w3-third">
        <div class="w3-card w3-container" style="min-height:460px">
            ...
            <a style="text-decoration: none;color: #FFFFFF" href="{{$linkha->telegram}}"><p style="color: #2a45ff;font-family: 'Segoe UI'">{{$linkha->telegram}}</p></a><br>
            <a style="text-decoration: none;color: #FFFFFF" href="{{$linkha->linkedin}}"><p style="color: #2a45ff;font-family: 'Segoe UI'">{{$linkha->linkedin}}</p></a><br>
            <a style="text-decoration: none;color: #FFFFFF" href=""><p style="color: #2a45ff;font-family: 'Segoe UI'">{{$linkha->instagram}}</p></a>
        </div>
    </div>
    ...
    <div class="w3-third">
        <div class="w3-card w3-container" style="min-height:460px">
            ...
            <p style="font-family: 'B Yekan';">{{$linkha->matn}}</p>
