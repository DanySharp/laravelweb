...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <h1 style="color: #1f57ff;font-family: 'B Yekan'" class="mt-2 text-center"><a href="<?php echo e(route('frontend.posts.show',$post->slug)); ?>"><?php echo e($post->title); ?></a></h1>
        <hr>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sitecms\resources\views/frontend/main/index.blade.php ENDPATH**/ ?>